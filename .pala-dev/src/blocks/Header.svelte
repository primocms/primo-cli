<header class:scrolled={is_scrolled} class:in-editor={is_editor}>
	<div class="header-container">
		<a href="/" class="logo">
			...
			{:else}
				<span class="logo-text">SaaS</span>
			{/if}
		</a>
...
<script>
	let { logo = {}, logo_text = '', nav_links = {}, nav_items = [], header_cta = {}, label = '', url = undefined, cta = {} } = $props()
