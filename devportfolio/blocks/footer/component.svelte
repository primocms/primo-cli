<footer class="footer">
	<div class="container">
		...
		<div class="footer-bottom">
			<p class="copyright">&copy; {$site?.copyright || '2026. All rights reserved.'}</p>
		</div>
	</div>
</footer>
